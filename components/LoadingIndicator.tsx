...
export const LoadingIndicator: React.FC<LoadingIndicatorProps> = ({ message }) => {
  return (
    <div className="flex flex-col items-center justify-center gap-6 p-8 rounded-lg bg-gray-800/50 animate-fade-in" role="status">
      ...
      <p className="text-lg font-medium text-gray-300 transition-all duration-500">{message}</p>
    </div>
  );
};
